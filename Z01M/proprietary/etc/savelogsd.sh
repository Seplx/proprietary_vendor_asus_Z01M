...
############################################################################################
	...
	cp -r /asdf/ASUS_VBUS_low_impedance.txt $SAVE_LOG_PATH
	cp -r /asdf/ASUS_AICL_suspend.txt $SAVE_LOG_PATH
	cp -r /asdf/gaugeMappingBackup $SAVE_LOG_PATH
	cp -r /asdf/recovery $SAVE_LOG_PATH
...
############################################################################################
	...
	cp -r /asdf/ASUS_thermal_alert.txt $SAVE_LOG_PATH/Power_Err_log
	cp -r /asdf/ASUS_thermal_alert_old.txt $SAVE_LOG_PATH/Power_Err_log
	cp -r /asdf/ASUS_JEITA_hard_hot.txt $SAVE_LOG_PATH/Power_Err_log
	cp -r /asdf/ASUS_JEITA_hard_hot_old.txt $SAVE_LOG_PATH/Power_Err_log
	cp -r /asdf/ASUS_JEITA_hard_cold.txt $SAVE_LOG_PATH/Power_Err_log
	cp -r /asdf/ASUS_JEITA_hard_cold_old.txt $SAVE_LOG_PATH/Power_Err_log
	cp -r /asdf/ASUS_Output_OVP.txt $SAVE_LOG_PATH/Power_Err_log
	cp -r /asdf/ASUS_Output_OVP_old.txt $SAVE_LOG_PATH/Power_Err_log
	echo " cp -r /asdf/ASUS_thermal_alert.txt $SAVE_LOG_PATH/Power_Err_log"
############################################################################################
...
############################################################################################
	cp -rf /data/media/0/bt* $SAVE_LOG_PATH/
